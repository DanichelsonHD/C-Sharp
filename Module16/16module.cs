...
namespace Module16
{
    class Program1
    {
        static void Main1(string[] args)
        {
            ...
            Console.WriteLine(linearSearch(example, 6));
        }
    }
    ...
    class Program2
    {
        static void Main2(string[] args)
        {
            ...
            List<int> example = new List<int> { 1, 2, 3, 4, 5, 6 };
            Console.WriteLine(binarySearch(example, 6));
        }
    }
    ...
    class Program3
    {
        ...
        {
            int[] example = new int[6] { 1, 2, 3, 4, 5, 6 };
    ...
    class Program4
    {
        ...
        {
            // probe = (low end + (high end - low end) x (item - data[lowEnd]))/(data[highEnd] - data[lowEnd])
    ...
    class Program6
    {
        ...
        public HashSet<int> BreadthFirstTraversalOnGraph (Node root)
        {
            ...
            if (!GraphA.AdjacencyList.ContainsKey(root))
            {
                return visited;
            }
